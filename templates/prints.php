  ...
  <body>
    ...
    <div id="wrapper">
      ...
      <div class="search-type">
        ...
        <a class="search-type-link selected" href="prints">Gravuras</a>
        <a class="search-type-link " href="inventory">Inventário</a>
      </div> 


      <form action="" method="post" id="search-form">
        <input type="hidden" name="print-operation" value="search">
        <input type="hidden" name="type" value="prints">
        <input placeholder="Pesquisar gravura..." class="search" type="text" name="search-words">
      ...
      <div class="artist-buttons">
        <button id="add-inventory" type="submit"><i class="fa fa-plus-square"></i>Adicionar ao Inventário</button>
      </div>
          ...
          foreach($prints as $print){ 
            if (!isset($search)) {                //se não houver palavras na pesquisa
              ...
              <?php 
                ...
                if($newArtist!=$artist){            //e a letra for diferente da anterior imprime-a
                  $artist=$newArtist;?>
                  <span class="search-divider"><?php echo $artist;?></span>
                <?php 
                } ?>
              <?php 
              }else if($searchBy=="technique"){  //se pesquisa por artista 
                $newTechnique=$print["print_technique"]; 
                if($newTechnique!=$technique){         //e a letra for diferente da anterior imprime-a
            ...
            <div class="print print-bienal" name="<?php echo $print["print_name"];?>">
              <form class="add-inventory-form" id="inventory-form<?php echo $print["print_id"];?>" action="" method="post"><input type="hidden" name="print-operation" value="add-inventory"><input type="hidden" name="print-name" value="<?php echo $print["print_name"];?>"><input type="hidden" name="print-id" value="<?php echo $print["print_id"];?>"></form>       
              <div class="print-pic">
                <div class="print-title-pic">
